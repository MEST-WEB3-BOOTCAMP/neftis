                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="title-heading">
                            ...
                            <p className="para-desc mx-auto text-muted mb-0">
                                Launch your campaign and benefit from our expertise in managing non-fungible
                                assets geared towards making a success of your transactions.
                            </p>
                            <div className="mt-4">
                                <a href="/#marketplace" className="btn btn-soft-primary ms-1">
                                    <i className="uil uil-file-bookmark-alt"/> Shop Now
                                </a>
                            </div>
                        </div>
                    </div>
